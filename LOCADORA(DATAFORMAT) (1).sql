...
/* selects */
SELECT DATE_FORMAT(lancamentoFilme, '%d/%m/%Y %H:%i') FROM filmes;
SELECT DATE_FORMAT(dataPedido, '%d/%m/%Y %H:%i') FROM locadora.emprestimo;
SELECT DATE_FORMAT(dataDevolucao, '%d/%m/%Y %H:%i') FROM locadora.emprestimo;
...
SELECT nomeFilme, nomeCli, categoria, nomeTraduzido, DATE_FORMAT(dataPedido, '%d/%m/%Y %H:%i'), DATE_FORMAT(dataDevolucao, '%d/%m/%Y %H:%i') FROM locadora.emprestimo e
...
join locadora.categoria i
 ...
 SELECT nomeFilme, nomeTraduzido, classificacaoFilme, categoria, nomeDistri, DATE_FORMAT(lancamentoFilme, '%d/%m/%Y %H:%i')FROM filmes f
...
/*catalogo de filmes*/ 
SELECT nomeFilme, classificacaoFilme, nomeDiretor, nomeAtor, categoria, nomeTraduzido, DATE_FORMAT(lancamentoFilme, '%d/%m/%Y %H:%i') from filmes f
join atores a
